...
my_api_key = "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"    # 在这里输入你的 API 密钥
#my_api_key = "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"
# jey+aip_key ="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“
initial_prompt = "你是一个会说中文的机器人助手"
...
title = """<h1 align="center">Edison的ChatGPT 🚀</h1>"""
description = """<div align=center>

由帅气的Edisonzzc [小猪猪Edison](https://space.bilibili.com/29125536) 开发

Edison是从这里dowing下来的 [GitHub项目](https://github.com/GaiZhenbiao/ChuanhuChatGPT)
...
print("小猪温馨提示：访问 http://localhost:7860 查看界面")
# 默认开启本地服务器，默认可以直接从IP访问，默认不创建公开分享链接
demo.title = "Edison的ChatGPT 🚀"
demo.queue().launch(server_name = "0.0.0.0", auth=("Edison", "zc1998619"),share=True) # 改为 share=True 可以创建公开分享链接
# demo.queue().launch(server_name="0.0.0.0", server_port=7860, share=False) # 可自定义端口
# demo.queue().launch(server_name="0.0.0.0", server_port=7860,auth=("Edison", "zc1998619"),share=True) # 可设置用户名与密码
